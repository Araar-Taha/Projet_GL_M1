...
async function main() {
    console.log("Démarrage du remplissage des départements...");
    
    for (const [code, nom] of Object.entries(DEPARTEMENTS_MAP)) {
...
main()
    ...
    .finally(async () => {
        // Optionnel : déconnexion Prisma si besoin
    });
